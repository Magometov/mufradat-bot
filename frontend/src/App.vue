<script setup lang="ts">
    ...
    /**
     * Листает раздел, в котором на сегодня пусто: там нет оценок, но есть расписание.
     *
     * Просмотр колоды тут не включается: прогон без сеанса и так идёт без оценок, а
     * флаг остался бы поднятым и после прогона — на всех экранах сразу.
     */
